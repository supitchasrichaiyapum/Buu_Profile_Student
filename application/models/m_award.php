...
class m_award extends CI_Model
{
        public function get_all(){
            $sql = "Select Award.Award_ID,Award.Award_Name, Award.Award_Term, Award.Award_Year, Award.Award_Date, Award.Award_Course, Award_has_Student.Student_ID, Student.Prefix, Student.Student_Name_TH, Student.Student_Lname_TH, Award.Award_Amount, Award.Award_Giver 
            from Award 
