...
<div class="col-sm-12">
          <div class="card">
            <div class="card-header">
              <strong><center>เพิ่มข้อมูลการลงทะเบียน</strong>
            </div>  
    
  <form role="form" action="<?php echo site_url('admin/c_admin/post_registstudent');?>" method="post" enctype="multipart/form-data">
        <div id="step-2">
