...
<div class="content-inner">
  ...
  <header class="page-header">
            ...
            <li><a href="<?php echo site_url('admin/c_admin/menu_admin');?>">หน้าหลัก</a></li>
                <li>เพิ่มข้อมูลเกรดเฉลี่ยแต่ละภาคเรียน</li>
  ...
  <div class="col-sm-12"><br>
          <div class="card">
            <div class="card-header">
              <h1><strong><center>เพิ่มข้อมูลเกรดเฉลี่ยแต่ละภาคเรียน</strong></h1>
            </div> 

            <form role="form" action="<?php echo site_url('admin/c_admin/post_gradstudent');?>" method="post" enctype="multipart/form-data" id="file_input">
              <div id="step-1">
